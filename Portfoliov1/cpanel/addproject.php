...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO `projects`( `title`, `descr`, `img`) VALUES ('$projname' , '$descr' , '$file')";
        $conn->query($sql);
        echo "<div style='color:green;margin-right:10px'>Successfully Added</div>";
    } else {
...
?>
<form class="d-xl-flex flex-column justify-content-xl-center align-items-xl-start" id="addProject" action="http://localhost/portfoliov1/cpanel/ypanel.php?page=addproj" method="post" enctype="multipart/form-data">
    <div class="d-xl-flex justify-content-xl-center align-items-xl-center" style="margin-top: 10px;"><label
            ...
            style="color: #ffffff;margin-right: 10px;">Project Image<i class="fa fa-chevron-right"></i></label><input
    ...
    <div
        ...
        <label
            ...
            style="color: #ffffff;margin-right: 10px;">Project Name&nbsp;<i class="fa fa-chevron-right"></i></label>
        <input class="bg-light border rounded-0 form-control" type="text" placeholder="Project Name" name="projname"></div>
    <div
        class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
        <label
            class="d-flex d-sm-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-xl-center align-items-xl-center"
            style="color: #ffffff;margin-right: 10px;">Project Description<i class="fa fa-chevron-right"></i></label>
        <textarea class="form-control" placeholder="Write about your project" name="descr"></textarea>
    </div>
    <div
        class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
        <button class="btn btn-primary bg-light border-primary" type="submit" style="color: #000000;" name="submit">add</button></div>
</form>